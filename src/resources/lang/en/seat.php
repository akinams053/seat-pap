...
return [
    ...
    'consumption_audit' => 'Consumption Audit',

    'consumption_hint' => 'External spending (lottery / shop) is grouped by session (order) for financial audit only; gameplay details live in the external service. Click a session to view per-entry debit / refund flow.',
    'consumption_col_session' => 'Session / Order',
    'consumption_col_merchant' => 'Merchant',
    'consumption_col_participants' => 'Participants',
    'consumption_col_debited' => 'Debited',
    'consumption_col_refunded' => 'Refunded',
    'consumption_col_net' => 'Net Spent',
    'consumption_col_last' => 'Last Activity',
    'consumption_col_member' => 'Member',
    'consumption_col_amount' => 'Amount',
    'consumption_col_reason' => 'Reason',
    'consumption_col_time' => 'Time',
