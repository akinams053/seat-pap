...
return [
    ...
    'operations' => '行动',
    'audit' => '行动审查',
    'consumption_audit' => '消费审查',

    'consumption_hint' => '抽奖 / 商店等外部消费按场次（订单）聚合，仅做资金审查；玩法明细在外部服务。点击场次查看逐笔扣款 / 退款流水。',
    'consumption_col_session' => '场次 / 订单',
    'consumption_col_merchant' => '商户',
    'consumption_col_participants' => '参与人',
    'consumption_col_debited' => '扣款',
    'consumption_col_refunded' => '退款',
    'consumption_col_net' => '净消费',
    'consumption_col_last' => '最近时间',
    'consumption_col_member' => '成员',
    'consumption_col_amount' => '金额',
    'consumption_col_reason' => '事由',
    'consumption_col_time' => '时间',
    ...
    'api_write_settings' => 'PAP 写接口设置（扣款 / 退款）',
    'api_write_description' => '生成独立的写 Token，授权外部抽奖 / 商店服务实时扣减或退还 PAP（debit / refund）。与只读 Token 分开存放、可单独轮换；写 Token 泄露不影响只读查询。',
    'api_write_token_label' => '写 Token',
    'api_write_usage' => '调用方式',
    'api_write_token_not_set' => '尚未生成写 Token。外部服务暂时无法扣款 / 退款。点击下方按钮生成。',
    'api_write_token_regenerated' => '写 Token 已重新生成。',
    'api_write_token_deleted' => '写 Token 已删除，扣款 / 退款接口已关闭。',
    ...
    'lottery_url_label' => '抽奖认证地址',
    'lottery_url_saved' => '抽奖地址已保存。',
    'lottery_url_invalid' => '抽奖地址格式不正确。',
    'lottery_url_not_configured' => '尚未配置抽奖地址，请在设置页面填写。',
