<div class="card card-info">
    <div class="card-header d-flex p-0 with-border">
        ...
        <ul class="nav nav-pills ml-auto p-2">
            <li role="presentation" class="nav-item">
                <a href="#new_tag" class="nav-link active" aria-controls="new_tag"
                   data-toggle="pill">{{ trans('calendar::seat.new') }}</a>
            </li>
            <li role="presentation" class="nav-item">
                <a href="#list_tag" class="nav-link" aria-controls="list_tag"
                   data-toggle="pill">{{ trans('calendar::seat.list') }}</a>
            </li>
        </ul>
    </div>
    <div class="card-body">
            ...
            <div role="tabpanel" class="tab-pane active" id="new_tag">
                <form class="form-horizontal" method="POST" action="{{ route('setting.tag.create') }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="number" min="0" step="1" class="form-control" name="order" id="tag_order"
                                   placeholder="{{ trans('calendar::seat.order_placeholder') }}">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="analytics"
                               class="col-sm-3 col-form-label">{{ trans('calendar::seat.analytic') }}</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        <label for="quantifier"
                               class="col-sm-3 col-form-label">{{ trans('calendar::seat.quantifier') }}</label>
                        <div class="col-sm-9">
                            <input type="number" min="0" step="0.5" class="form-control" name="quantifier"
                                   id="quantifier" value="1"/>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="bg_color"
                               class="col-sm-3 col-form-label">{{ trans('calendar::seat.background') }}</label>
                        <div class="col-md-9">
                            <div class="input-group colorpicker-component" id="tag_bg_color">
                                <input type="text" name="bg_color" value="#000" class="form-control"
                                       maxlength="7"
                                       placeholder="{{ trans('calendar::seat.background_placeholder') }}"/>
                    ...
                    <div class="form-group row">
                        <label for="text_color"
                               class="col-sm-3 col-form-label">{{ trans('calendar::seat.text_color') }}</label>
                        <div class="col-sm-9">
                            <div class="input-group colorpicker-component" id="tag_text_color">
                                <input type="text" name="text_color" value="#fff" class="form-control"
                                       maxlength="7"
                                       placeholder="{{ trans('calendar::seat.text_color_placeholder') }}"/>
                                <span class="input-group-addon"><i></i></span>
                            </div>
                        </div>
                    </div>
                            ...
                            <td>
                                <span class="clickable text-right">
                                    <button type="button" class="btn btn-xs btn-link" data-toggle="modal"
                                            data-tag-id="{{ $tag->id }}" data-target="#modalEdit">
                                        <i class="fas fa-pencil-alt text-primary"></i>
                                    </button>
                                    <button type="button" class="btn btn-xs btn-link" data-toggle="modal"
                                            data-tag-id="{{ $tag->id }}" data-target="#modalConfirmDelete">
    ...
    <div class="card-footer">
        <button type="submit" class="btn btn-info float-right"
                form="form-new-tag">{{ trans('calendar::seat.save') }}</button>
    </div>
</div>
