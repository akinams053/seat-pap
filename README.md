...
>
> 生产状态：`2.0.0` 已于 2026-06-06 部署到生产服；部署记录与回退快照见 [`docs/04-交接说明.md`](docs/04-交接说明.md#8-生产部署记录2026-06-06)。
...
> 生产环境升级应按可回退流程执行（整站 tar + 整库快照）。`2.0.0` 生产部署已完成，流程与回退方案见 [`docs/07-生产部署计划.md`](docs/07-生产部署计划.md)，实际部署记录见 [`docs/04-交接说明.md`](docs/04-交接说明.md#8-生产部署记录2026-06-06)。
...
- [`04 · 交接说明`](docs/04-交接说明.md)：测试服验证、生产部署记录、接手注意事项
- [`07 · 生产部署计划`](docs/07-生产部署计划.md)：可回退的生产部署方案与 2.0.0 执行记录
